...
namespace Sys_C_V_Dario_SVII.Models.Mod_Compra.Com_Compra
{
    public class Com_CompraBE
    {
        ...
        public Mod_Sistema.Rol_Usuario.Rol_UsuarioBE oUsuarioComprador { get; set; }
        public Mod_Sistema.Rol_Tipo_Usuario.Rol_Tipo_UsuarioBE oTipoUsuarioRegistrador { get; set; }
        public Mod_Sistema.Rol_Usuario.Rol_UsuarioBE oUsuarioRegistrador { get; set; }
        ...
        public Com_CompraBE()
        {
            ...
            oUsuarioComprador = new Mod_Sistema.Rol_Usuario.Rol_UsuarioBE();
            oTipoUsuarioRegistrador = new Mod_Sistema.Rol_Tipo_Usuario.Rol_Tipo_UsuarioBE();
            oUsuarioRegistrador = new Mod_Sistema.Rol_Usuario.Rol_UsuarioBE();
